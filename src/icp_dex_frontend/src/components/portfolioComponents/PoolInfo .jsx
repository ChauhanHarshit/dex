    ...
    <div className='w-full h-screen  text-white  md:max-w-[80%] mt-28 z-50 px-8 mx-auto'>
      ...
      <div className='flex flex-col justify-between bg-[#010427] p-2  py-6  rounded-lg mx-auto'>
        <div className='flex justify-between items-center  mx-2  md:mx-16'>
          <div className='font-cabin text-xl md:text-3xl font-medium flex items-center gap-4'>
            <div className='flex gap-2'>
              {
                TokenData.PoolData.map((token, index) => (
                  <div key={index}>
                    <div className='bg-[#3D3F47] p-1 rounded-lg'>
                      <img src={token.ImagePath} alt="" className='w-10 h-10' />
                    </div>
                  </div>
                ))
              }
        ...
        <div className='flex w-full gap-3 mx-auto '>
          ...
          <div className=' flex flex-col w-3/12 gap-4 my-4'>
        ...
        <div className='flex gap-6 my-4 mx-10'>
          <div>
            <GradientButton>
              Swap Tokens
            </GradientButton>
        ...
        <div className='font-cabin font-medium text-2xl flex gap-32 mx-10 my-6'>
          {Heading.map((heading, index) => (
            <div className='flex flex-col justify-center items-center gap-2 cursor-pointer' key={index}
              onClick={() => {
                setCurrIndex(index)
              }}>
              <h1>{heading}</h1>
